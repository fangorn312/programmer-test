...
public class SettingsFragment extends Fragment implements EasyPermissions.PermissionCallbacks, OnBackPressedListener {
    ...
    private static final String URL_TO_DB = "https://github.com/fangorn312/epi1-16/raw/master/ProgrammerTest/myDB.sqlite";
    private static final String URL_TO_INFO = "https://raw.githubusercontent.com/fangorn312/epi1-16/master/ProgrammerTest/dataBaseInfo.txt";
...
//                        URL_TO_DB = editTextUrl.getText().toString();
                    new DownloadFile().execute(URL_TO_INFO, URL_TO_DB);
